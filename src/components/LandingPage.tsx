...
//   return (
//     <div className="min-h-screen transition-colors duration-700 bg-gradient-to-br from-slate-100 via-slate-200 to-cyan-100 dark:from-slate-900 dark:via-slate-800 dark:to-cyan-900">
...
//             The ultimate collaboration platform for developers. Share updates,
//             chat live, and form squads to build the next big thing.
//           </p>
...
//         dark:from-slate-900 dark:via-slate-800 dark:to-cyan-900
//         pt-24  /* compensate for navbar height (~96px) */
//         pb-16  /* keep bottom breathing room */
//         overflow-x-hidden
//       "
//     >
...
//             <Badge
//               variant="secondary"
//               className="gap-2 text-sm px-4 py-2 border border-cyan-500/30 
//                          bg-gradient-to-r from-cyan-400/20 to-orange-400/20 
//                          dark:from-cyan-500/20 dark:to-orange-500/20"
//             >
//               <Sparkles className="h-4 w-4 text-cyan-500 dark:text-cyan-400" />
//               Now in Beta
//             </Badge>
...
//               bg-gradient-to-r from-cyan-500 via-orange-400 to-amber-400 
...
//               mb-8 max-w-3xl mx-auto transition-colors
//             "
//           >
//             The ultimate collaboration platform for developers. Share updates,
//             chat live, and form squads to build the next big thing.
...
//               className="
//                 gap-2 text-lg px-8 py-6 
//                 border-orange-400/50 text-orange-500 dark:text-orange-400 
...
//                     className="
//                       p-3 rounded-full 
//                       bg-gradient-to-br from-cyan-400/20 to-orange-400/20 
//                       dark:from-cyan-500/20 dark:to-orange-500/20
//                     "
//                   >
//                     <feature.icon className="h-8 w-8 text-cyan-600 dark:text-cyan-400" />
